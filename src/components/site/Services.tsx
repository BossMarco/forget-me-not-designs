    ...
    <section id="services" className="relative bg-secondary/40 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
          {services.map((s, i) => (
            <Reveal key={s.title} delay={i * 110} className="flex">
              <article className="group relative flex flex-1 flex-col rounded-3xl border border-border/60 bg-card p-8 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-[var(--shadow-soft)] hover:border-primary/30">
